...
This repository provides a Snakemake pipeline for reproducing results in manuscript _Predicting protein interaction and proximity evidence with weakly supervised learning (Kasmaeifar et al., 2026)_.
